...
item:copy('picker-infinity-active-chest'):set_fields {icon = ico_path .. 'infinity-active-chest.png', icon_size = 32}:subgroup_order(nil, 'b')
item:copy('picker-infinity-passive-chest'):set_fields {icon = ico_path .. 'infinity-passive-chest.png', icon_size = 32}:subgroup_order(nil, 'c')
item:copy('picker-infinity-storage-chest'):set_fields {icon = ico_path .. 'infinity-storage-chest.png', icon_size = 32}:subgroup_order(nil, 'd')
item:copy('picker-infinity-buffer-chest'):set_fields {icon = ico_path .. 'infinity-buffer-chest.png', icon_size = 32}:subgroup_order(nil, 'e')
item:copy('picker-infinity-requester-chest'):set_fields {icon = ico_path .. 'infinity-requester-chest.png', icon_size = 32}:subgroup_order(nil, 'f')
